...
from blogspot.forms import RegistrationForm, LoginForm, UpdateAccountForm, PostForm
...
def account():
      ...
      if form.validate_on_submit():
           ...
           db.session.commit()
           flash('Your account has succefully been updated!', 'success')
...
def update_post(post_id):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('Your Post has been succefully updated', 'success')
...
def delete_post(post_id):
    ...
    db.session.commit()
    flash('Your Post has been succefully been deleted', 'success')
    return redirect(url_for('home'))
